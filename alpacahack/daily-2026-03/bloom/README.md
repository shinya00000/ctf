...
## 1. 概要
本問題は提供されたPythonスクリプト `server.py` が動作するサーバーと通信し，暗号化されたフラグを解読するCrypto問題です．独自の乱数生成関数を用いたXOR暗号化が実装されていますが，その乱数の範囲指定に起因する偏りを利用して平文を復元します．
...
<https://github.com/shinya00000/ctf/blob/main/alpacahack/daily-2026-03/bloom/solve.ipynb>
